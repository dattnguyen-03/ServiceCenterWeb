...
interface UserProfile {
  userName: string; // Backend trả về userName thay vì username
  fullName: string;
  email: string;
  phoneNumber: string;
  address: string;
...
const AdminProfile: React.FC = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      console.log('Profile data from API:', rawProfileData); // Debug log
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Card title="Thông tin tài khoản Admin" className="shadow-lg">
