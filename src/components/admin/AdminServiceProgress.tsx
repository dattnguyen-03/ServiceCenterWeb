...
const AdminServiceProgress: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Tiến độ dịch vụ - Admin</h2>
          <p className="text-gray-600">Theo dõi và quản lý tiến độ thực hiện dịch vụ toàn hệ thống</p>
        </div>
...
export default AdminServiceProgress;
